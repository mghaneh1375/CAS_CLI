 ...
 */
package bogen.studio.cas_client.Kavenegar;

import com.google.gson.*;
import bogen.studio.cas_client.Kavenegar.enums.MessageType;
import bogen.studio.cas_client.Kavenegar.excepctions.ApiException;
import bogen.studio.cas_client.Kavenegar.excepctions.BaseException;
import bogen.studio.cas_client.Kavenegar.excepctions.HttpException;
import bogen.studio.cas_client.Kavenegar.models.*;
import bogen.studio.cas_client.Kavenegar.utils.PairValue;
import bogen.studio.cas_client.Kavenegar.utils.StringUtils;
    ...
    */
    ...
    public SendResult verifyLookup(String receptor, String token, String token2, String token3, String template, List<PairValue> params) throws BaseException {
        ...
        for (PairValue Key : params) {
            if (null != Key.getKey()) switch ((String) Key.getKey()) {
                case "token10":
                    token10 = (String) Key.getValue();
                    break;
                case "token20":
                    token20 = (String) Key.getValue();
                    break;
            }
        }
